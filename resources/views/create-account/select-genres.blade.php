...
@section('content')
    @php
        $currentStep = 2;
        $genres = [
            ['id' => 1, 'name' => 'Ficção Científica', 'icon' => 'bx-atom'],
            ['id' => 2, 'name' => 'Romance', 'icon' => 'heroicon-o-heart'],
            ['id' => 3, 'name' => 'Fantasia', 'icon' => 'heroicon-o-sparkles'],
            ['id' => 4, 'name' => 'Terror', 'icon' => 'ri-ghost-fill'],
            ['id' => 5, 'name' => 'Suspense', 'icon' => 'heroicon-o-eye'],
            ['id' => 6, 'name' => 'Biografia', 'icon' => 'heroicon-o-user'],
            ['id' => 7, 'name' => 'Drama', 'icon' => 'heroicon-o-film'],
            ['id' => 8, 'name' => 'Autoajuda', 'icon' => 'heroicon-o-light-bulb'],
            ['id' => 9, 'name' => 'Mistério', 'icon' => 'heroicon-o-question-mark-circle'],
            ['id' => 10, 'name' => 'História', 'icon' => 'heroicon-o-book-open'],
            ['id' => 11, 'name' => 'Poesia', 'icon' => 'heroicon-s-pencil'],
            ['id' => 12, 'name' => 'Aventura', 'icon' => 'heroicon-o-rocket-launch'],
        ];
                        ...
                        @foreach ($genres as $genre)
                            <label class="relative cursor-pointer group">
                                ...
                                <div
                                    ...
                                    <x-dynamic-component :component="$genre['icon']" class="w-8 h-8 text-muted mb-2" />
